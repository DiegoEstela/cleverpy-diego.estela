...
function PostContainer({ posts, currentUser }: PropTypesPost): JSX.Element {
  const [modal, setModal] = useState<IModalContain>({
    open: false,
    post: null,
  });
    ...
    <Container>
      ...
      <CardContainer>
        {currentUser ? (
                ...
                <Card key={post.id}>
                  ...
                  <div className="face back">
                    ...
                    <div className="boxIcon">
                      ...
                      <FaEdit
                        className="icon"
                        onClick={(e) => setModal({ open: true, post })}
                      />
                    </div>
                  </div>
                </Card>
          ...
          <TitleNoLogin>
            {" "}
            No se puede acceder a los post por favor logueate
          </TitleNoLogin>
        )}
      </CardContainer>
    </Container>
